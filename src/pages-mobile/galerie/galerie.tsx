...
const GalerieMobile = () => {
	...
	return (
		<div className="galerieMobile">
			<section className="galerie-hero-mobile">
			...
			<section className="galerie-filters-mobile">
			...
			<section className="galerie-grid-mobile">
			...
			{lightboxIndex !== null && (
				<div className="lightbox-mobile" onClick={closeLightbox}>
					<div
